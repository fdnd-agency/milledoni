...
// make sure components start with a capital letter in both the route and naming during export
...
export {  default as MenuButton } from './component/MenuButton.svelte'
export {  default as Product } from './component/Product.svelte'
export {  default as LikeButton } from './component/LikeButton.svelte'
export {  default as Filter } from './component/Filter.svelte'
export {  default as SendIcon } from './component/SendIcon.svelte'